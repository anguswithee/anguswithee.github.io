...
```{r fig4, fig.cap="Figure 4: NC Public School Racial Demographic Trends (2014-2024)."}
...
```{r fig8, fig.cap="Figure 8: Watauga County Public School Percentage of Students of Color Over Time (2014-2024)."}
